...
public class Main {
	public static void main(String[] args) {
		...
		case 9:
			...
			JefeEstación jefe1 = new JefeEstación("CDF", "35678921X");
			
			Vagones vagon1 = new Vagones(4321, 288, "Electronicos");
			Locomotoras locomotora1 = new Locomotoras("2467 JBG", 7600,"2000", mecanico1);
